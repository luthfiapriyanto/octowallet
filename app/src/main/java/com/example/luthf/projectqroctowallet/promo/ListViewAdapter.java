package com.example.luthf.projectqroctowallet.promo;
...
import com.example.luthf.projectqroctowallet.DetailPromo;
...
public class ListViewAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		desc.setText(resultp.get(PromoActivity.DESC));
